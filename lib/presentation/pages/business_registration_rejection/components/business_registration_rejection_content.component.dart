...
class BusinessRegistrationRejectionContent
    extends GetView<BusinessRegistrationRejectionController> {
  const BusinessRegistrationRejectionContent({super.key});
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      ...
      final ctaText =
          controller.shouldResubmitThroughVerification
              ? 'Review verification and resubmit'
              : 'Review and resubmit';
      ...
      return ListView(
        ...
        children: [
                  ...
                  LNDText.regular(
                    text:
                        reviewedDateText == null
                            ? 'Your business registration was reviewed.'
          ...
          LNDButton.primary(
            text: ctaText,
            enabled: true,
            onPressed: controller.reviewAndResubmit,
          ),
        ],
      );
    });

    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
            ...
            children: [
              ...
              Flexible(
                child: LNDVerifiedName(
                  name: LNDUtils.formatSimpleUserName(booking.asset?.owner),
                  verificationLevel: booking.asset?.owner?.verified,
                  showBusinessBadge:
                      booking.asset?.owner?.hasDisplayName == true,
          ...
          Visibility(
            visible: booking.canViewConfirmedOwnerInfo,
            child: Row(
              mainAxisSize: MainAxisSize.min,
              spacing: 12.0,
              children: [
                Expanded(
                  child: LNDButton.secondary(
                    enabled: booking.canStartHandover,
                    icon:
                        isOwner
                ...
                Expanded(
                  child: LNDButton.secondary(
                    enabled: booking.canStartReturn,
                    icon:
                        isOwner
                            ? Icons.camera_alt_rounded
                            : Icons.qr_code_scanner_rounded,
